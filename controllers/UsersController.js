...
function UsersController() {
    ...
    return {
        ...
        async getAllUsers(req, res) {
            ...
            try {
                const usuarios = await Users.findAll({ attributes: { exclude: ['password', 'createdAt', 'updatedAt'] } })
        ...
        async getUserById(req, res) {
            ...
            const usuario = await Users.findOne({attributes:  { exclude: ['password', 'createdAt', 'updatedAt'] },  where: { id } })
